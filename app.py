...
client = MongoClient("mongodb+srv://yael:yrQXgA3eErHJqERx@uptlax.z0qdy.mongodb.net/?retryWrites=true&w=majority&appName=UPTlax")
db = client['bd1'] 
...
def enviar_email(destinatario, asunto, cuerpo):
    mensaje = Mail(
        from_email='Yael.20082004@gmail.com',  
